...
// Enable Inbox tile when message is deleted and user is redirected to inbox messages
if (window.location.href.indexOf("messages") > -1) {
	$('#messaging-navi .navbar-nav').find('li.active').removeClass('active');
	$('#messaging-navi .navbar-nav').find('a[href="/messages/"]').parent('li').addClass('active');
}
